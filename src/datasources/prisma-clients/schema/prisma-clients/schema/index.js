...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/home/abhijeet/Projects/work/big-project-for-testing/task-manager-testing/src/datasources/prisma-clients/schema/prisma-clients/schema",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "/home/abhijeet/Projects/work/big-project-for-testing/task-manager-testing/src/datasources/prisma-clients/schema/schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
  ...
  "inlineSchemaHash": "d684587d34e2e85723339166afc36269bc4f734c8ffac4f92d4a04d9613f8294",
  "copyEngine": true
}
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "src/datasources/prisma-clients/schema/prisma-clients/schema",
    "datasources/prisma-clients/schema/prisma-clients/schema",
  ]
...
path.join(process.cwd(), "src/datasources/prisma-clients/schema/prisma-clients/schema/libquery_engine-debian-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "src/datasources/prisma-clients/schema/prisma-clients/schema/schema.prisma")
